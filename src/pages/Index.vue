    ...
    <div class="relative bg-indigo-800">
      <div class="absolute inset-0">
        <g-image
          ...
          src="~/images/IMG_5100.jpeg?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1920&q=60&&sat=-100"
          alt=""
        />
        <div
      ...
      >
        ...
        <p class="mt-6 text-3xl text-indigo-100 max-w-3xl">
          A new model for
          <strong>community-owned, artist-stewarded</strong> creative spaces for
          communities to live, work, learn and thrive in a network across the
          City of Toronto.
        </p>
      </div>
    </div>

    <div class="pb-12 md:px-0 cell flex flex-col text-lg max-w-prose mx-auto">
      <div class="md:pr-6 mt-12">
        <p class="text-3xl font-bold">
          We are convening partners for the Office of Creative Space
          collaborative. If you're a Toronto-based arts nonprofit, creative
        ...
        <p>
          ...
          partnership with artist stewards.
        </p>

        <p>
          In an unrestrained commercial market, artists and creators will seek
          equitable and community-centred models for production and exhibition
          space that allow meaningful connection to local neighbourhoods
          –&nbsp;rather than relying on community benefit agreements to
          materialize years after big developments tear holes in the
          streetscape.
        </p>
        ...
        <p>
          Artists and community members freely share their needs and feedback to
          improve spaces and the network for all, and feel a strong connection
          to the shared resources, assets and people in their communities.
        </p>

        <p>
          We see a near future where a sustainable system has been established
          that reliably improves the ability of communities to increase asset
          ownership and ensure local social resilience.
        </p>
        ...
        <p>
          ...
          neighbourhood advocacy groups and our local city councillor, TMAC,
          Urbancorp and the City of Toronto finalized an agreement that would
          provide the developer a density bonus in exchange for a turnkey,
          purpose-built, 38,000 sq. ft. facility for TMAC. However, the
        ...
        <ul>
          <li>
            Provide training, mentorship, and HR support to arts nonprofits and
            collectives to support the development of sustainable financial and
            governance models
          </li>
          <li>Develop and manage a community algorithmic trust.</li>
          <li>
            Develop partnerships with social enterprises to anchor spaces and
            diversify revenue models for community-owned assets.
          </li>
          <li>
            In collaboration with arts organizations and artists, collect data,
            measure results and publish reports on barriers (structural,
            ethical, financial) and solutions to permanent space for artists in
            Canada.
          </li>
          <li>
            Advocate at all levels of government for increased direct supports
            to arts organizations operating community spaces.
          </li>
          <li>
            Develop a coalition of smaller-scale, infill developers focused on
            meeting the affordable housing and economic development needs of
            communities.
          </li>
          <li>
            Assist arts and community groups’ capitalization to acquire real
            estate.
          </li>
        </ul>
        ...
        <p>
          We are convening partners for the Office of Creative Space
          collaborative. If you&#39;re a Toronto-based arts nonprofit, creative
          social enterprise, or supportive individual or business, we&#39;d love
...
h2 {
  @apply font-display mb-3 mt-12 font-bold text-3xl tracking-normal;
}
...
table {
  td {
    @apply border-black border-2 p-3;
  }
}
ul {
  @apply list-outside pl-2;
  li {
